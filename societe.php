        ...
        <div class="row justify-content-center bloc-texte cadre">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-4 col-sm-10 d-flex align-items-center">
              <img class="img-fluid  mx-0 my-0" src="imgs/societe_01.jpg" alt="" >
            </div>
            <div class="col-lg-7 col-md-6 col-sm-12">

              <h4 class="mx-auto">Historique<hr></h4>
    ...
    <div class="row justify-content-end ">
      ...
      <div class="row justify-content-center bloc-texte cadre">
        <div id="zone2-entreprise" class="row justify-content-center">
          ...
          <div class="col-lg-7 col-md-6 col-sm-12  ">
            <h4 class="mx-auto">Développement durable<hr></h4>
    ...
    <div class="row justify-content-end">
      ...
      <div class="col-lg-9  col-md-12 col-sm-12  ">
        <div class="row justify-content-center bloc-texte cadre">
          ...
          <div class="row justify-content-center ">
            <div class="col-lg-5 col-md-4 col-sm-10 d-flex align-items-center mx-0 my-0">
              <img class=" mx-0 my-0 img-fluid" src="imgs/societe_03.jpg" alt="">
            </div>

            <div class="col-lg-7 col-md-6 col-sm-12  align-items-center">
              <h4 class="">La chaine de production<hr></h4>
