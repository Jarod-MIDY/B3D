...
<section class="container w-75"><br><br>
	...
	<section class="row cadreCGU"><br>
		<h5 class="w-100">ARTICLE 2 : Mentions légales      <hr></h5><br>
		<p>Pour les personnes morales :<br><br>
			...
			Le site B3D est édité par XXX, domicilié au XXX.</p>
	</section>
    <section class="row cadreCGU"><br>
        <h5 class="w-100">ARTICLE 3 : accès aux services      <hr></h5><br>
        <p>L’Utilisateur du site B3D a accès aux services suivants : </p><br>
            <ul>
                <li>XXXXXXX</li>
                <li>YYYYYYYYYYYYY</li>
            </ul>
            ...
            Les services suivants ne sont pas accessible pour l’Utilisateur que s’il est membre du site (c’est-à-dire qu’ile st identifié à l’aide de ses identifiants de connexion) :</p><br>
            <ul>
                <li>WWWWWWWWWW</li>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 4 : Responsabilité de l’Utilisateur      <hr></h5><br>
            <p>L'Utilisateur est responsable des risques liés à l’utilisation de son identifiant de connexion et de son mot de passe. <br>
            ...
            L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site [votre site].<br>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 5 : Responsabilité de l’Éditeur      <hr></h5><br>
            <p>Tout dysfonctionnement du serveur ou du réseau ne peut engager la responsabilité de l’Éditeur.<br>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 6 : Propriété intellectuelle      <hr></h5><br>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 7 : Données personnelles      <hr></h5><br>
            <p>L’Utilisateur doit obligatoirement fournir des informations personnelles pour procéder à son inscription sur le site. <br>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 8 : Liens hypertextes      <hr></h5><br>
            <p>Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de [votre site], qui n’a pas de contrôle sur ces liens.<br>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 9 : Évolution des conditions générales d’utilisation      <hr></h5><br>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 10 : Durée du contrat      <hr></h5><br>
    ...
    <section class="row cadreCGU"><br>
            <h5 class="w-100">ARTICLE 11 : Droit applicable et juridiction compétente      <hr></h5><br>
