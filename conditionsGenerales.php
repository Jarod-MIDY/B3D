...
<html>
<head>
	<title>B3D - Nos conditions générales</title>
	<link rel="stylesheet" type="text/css" href="styles_.css">
</head>
<body><div class= col-xl-12 style="background-color: #b95c16; color: black; list-style: none; padding: 40px">


	<h1>Conditions générales d'utilisation du site B3D</h1>
    ...
    <p>L’Utilisateur du site B3D a accès aux services suivants :<br>
        <li>
        <ul>XXXXXXX</ul>
        <ul>YYYYYYYYYYYYY</ul>
        <ul>WWWWW</ul>
        <ul>ZZZZZZZZZZZZZZZZZZZZZZZZZZ</ul>
        </li>
    ...
    Les services suivants ne sont pas accessible pour l’Utilisateur que s’il est membre du site (c’est-à-dire qu’ile st identifié à l’aide de ses identifiants de connexion) :<br>
        <li>
        <ul>WWWWWWWWWW</ul>
        <ul>ZZZZZZZZZZZZZZZZZZZZZZZZZZZ</ul>
        </li>
    ...
    En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. <br>
       L'Utilisateur exerce ce droit via :
        <li>
        <ul>• Un formulaire de contact</ul>
        <ul>• Par voie postale à l'adresse :<br>B3D<br>    "L'intendant",<br>47700 Poussignac.</ul>
        </li>
